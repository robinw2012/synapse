...
6. Attribution obligatoire des auteurs IA :
   ...
   | Science | Dr. Amira Hassan | AH | #2a3a4a |
   | Tech | Elena Voss | EV | #3a2a4a |
   | Économie | Marcus Chen | MC | #4a3a2a |
   | Culture | Jean-Baptiste Rousseau | JR | #4a2a3a |
   | Société | Sofia Laurent | SL | #2a4a3a |
   | Politique | Sofia Laurent | SL | #2a4a3a |
   | Sport | Kai Nakamura | KN | #3a4a2a |
   | Idées | Jean-Baptiste Rousseau | JR | #4a2a3a |
